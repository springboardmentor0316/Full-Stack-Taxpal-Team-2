...
import { BarChart3, CreditCard, PieChart, FileText, Settings, Menu, X, TrendingUp, TrendingDown, LogOut } from 'lucide-react';
...
export default function TaxPalDashboard() {
  ...
  const stats = [
    { title: 'monthly income', amount: '10000', color: 'stat-yellow', icon: TrendingUp },
    { title: 'monthly expenses', amount: '10000', color: 'stat-orange', icon: TrendingDown },
    { title: 'Estimated Tax due', amount: '10000', color: 'stat-blue', icon: FileText },
    { title: 'Savings Rate', amount: '10000', color: 'stat-green', icon: TrendingUp },
  ];
